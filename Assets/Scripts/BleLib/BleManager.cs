...
public delegate void imuDataCallback (float aX, float aY, float aZ, float gX, float gY, float gZ);
...
{
    // Library importation
    private const string lib = "Ble-2.0.20.dll";
    [DllImport(lib)]
